...
dat_example <- data.frame(
  study = c("Study A", "Study B", "Study C", "Study D", "Study E", "Study F", "Study G", "Study H", "Study I"),
  ...
  # Bias direction types (e.g. additive)
  d1t = d2t <- d3t <- d4t <- d5t <- d6t <- d7t <- rep("a", 9),

  # Bias direction codes
  d1d = c("la", "ra", "lp", "rp", "up", "ua", "rp", "la", "up"),
  d2d = c("lp", "ra", "rp", "up", "ua", "la", "rp", "lp", "la"),
  d3d = c("ua", "ua", "ua", "ua", "ua", "ua", "rp", "rp", "ua"),
  d4d = c("la", "ra", "rp", "rp", "rp", "ua", "ua", "ua", "ua"),
  d5d = c("lp", "lp", "rp", "rp", "rp", "rp", "rp", "ua", "ua"),
  d6d = c("ua", "ua", "ua", "ua", "ua", "ua", "ua", "ua", "ua"),
  d7d = c("ua", "ua", "ua", "ua", "ua", "ua", "ua", "ua", "ua")
)
